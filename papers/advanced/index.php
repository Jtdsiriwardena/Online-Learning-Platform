...
<html lang="en">
  <head>
    ...
    <title>ADVANCED LEVEL PASTPAPERS</title>
  ...
  <div class="main">
    ...
    <form action="index.php" method="post" enctype="multipart/form-data">
       ...
       <h1>Advanced Level Pastpapers</h1>
    ...
    <?php
                ...
                while($row = $result->fetch_assoc()) {
                      ...
                      <td> 
                        <a href='http://localhost/AlphaLearner/papers/advanced/delete.php ?id=$row[id]'>Delete</a>
                        <a href='http://localhost/AlphaLearner/papers/advanced/update.php ?id=$row[id]'>Update</a>
                      </td>
                    </tr>
                      ";   
                }
